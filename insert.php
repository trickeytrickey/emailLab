...
//you need to use HTML5 validator
...
<head>
    ...
    <style type="text/css">
		...
		li input:focus { border: 1px solid #000; width: 400px; overflow:auto; margin:10px;}
...
<form id="form0" method="post" action="doInsert.php">
	<fieldset>
        ...
        <ul>
        	<li><label title="ShipperID" for="shipperID">ShipperID</label><input name="shipperID" id="shipperID" type="text" size="20" maxlength="3"/></li>
